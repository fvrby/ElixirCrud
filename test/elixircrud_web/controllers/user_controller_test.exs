defmodule ElixircrudWeb.UserControllerTest do
  ...
  @create_attrs %{apellido: "some apellido", comuna: "some comuna", direccion: "some direccion", edad: 42, fecha_nacimiento: ~D[2010-04-17], nombre: "some nombre", region: "some region", rut: "some rut"}
